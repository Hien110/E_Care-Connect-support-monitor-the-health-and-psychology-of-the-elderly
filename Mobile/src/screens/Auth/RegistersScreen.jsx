...
export default function RegistersScreen() {
  ...
  const handleComplete = async () => {
    ...
    try {
      ...
      setLoading(false)
      if (res.success) {
        // có thể thêm navigation tới màn hình khác
      }
    } catch (e) {
      setLoading(false)
    }
    ...
    <SafeAreaView style={{ flex: 1, padding: 16 }}>
      ...
      {step === 1 && (
        <View style={{ flex: 1, justifyContent: "center", alignItems: "center", padding: 16 }}>
          ...
          >
            <Text style={{ fontSize: 18, fontWeight: "600", color: "#007bff", marginBottom: 4 }}>Người cao tuổi</Text>
          ...
          >
            <Text style={{ fontSize: 18, fontWeight: "600", color: "#007bff", marginBottom: 4 }}>
              Thành viên gia đình
            </Text>
            <Text style={{ fontSize: 14, color: "#666" }}>
          ...
          >
            <Text style={{ color: "#fff", textAlign: "center", fontWeight: "600" }}>TIẾP TỤC</Text>
          </TouchableOpacity>

          <Text style={{ fontSize: 14 }}>
            Bạn đã có tài khoản? <Text style={{ color: "#007bff", fontWeight: "600" }}>Đăng nhập ngay</Text>
          </Text>
        </View>
      )}
      ...
      {step === 2 && (
        <View style={{ flex: 100, justifyContent: "center", padding: 16 }}>
          ...
          <Text style={{ fontSize: 24, fontWeight: "bold", textAlign: "center", marginBottom: 24 }}>E-CARE</Text>
          <Text style={{ fontSize: 18, fontWeight: "600", textAlign: "center", marginBottom: 24 }}>Đăng Ký</Text>
          ...
          >
            <Text style={{ color: "#fff", textAlign: "center", fontWeight: "600" }}>Đăng ký</Text>
          </TouchableOpacity>
      ...
      {step === 2.1 && (
        <View style={{ flex: 1, paddingTop: 80, alignItems: "center" }}>
          ...
          <Text style={{ fontSize: 22, fontWeight: "bold", marginBottom: 12 }}>Xác thực số điện thoại</Text>
