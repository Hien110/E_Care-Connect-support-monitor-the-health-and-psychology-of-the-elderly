// HomeScreen.jsx (friendly layout)
...
export default function HomeScreen() {
  ...
  const findSupport = () =>
    Alert.alert("Tìm người hỗ trợ", "🔍 Giúp việc • 👩‍⚕️ Y tá tại nhà • 🚗 Đưa đón")
      ...
      <ScrollView contentContainerStyle={styles.container} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.header}>
          <View style={styles.headerTop}>
            <View>
              <Text style={styles.hi}>Chào, bác Minh!</Text>
        ...
        <Section title="Trường hợp khẩn cấp" icon="🆘" color="#EA3D3D">
          <View style={styles.emgCard}>
            ...
            <Text style={styles.emgDesc}>
              Nhấn nút để hệ thống tự liên hệ 115, gia đình và bác sĩ.
            </Text>
...
const styles = StyleSheet.create({
  ...
  emgIconWrap:{ width:54, height:54, borderRadius:16, alignItems:"center", justifyContent:"center",
